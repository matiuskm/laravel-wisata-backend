                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" placeholder="Description" name="description" id="description">{{ old('description', $product->description) }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                        ...
                                        @enderror"
                                            ...
                                            min="0" required value="{{ old('price', $product->price) }}">
                                    </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="btn-group" role="group" data-bs-toggle="buttons">
                                        <input type="radio" class="btn-check" id="perorangan" name="criteria"
                                            value="perorangan" @if ($product->criteria == 'perorangan') checked @endif>
                                        <label class="btn btn-primary" for="perorangan">Perorangan</label>

                                        <input type="radio" class="btn-check" id="rombongan" name="criteria"
                                            value="rombongan" @if ($product->criteria == 'rombongan') checked @endif>
