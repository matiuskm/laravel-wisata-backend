                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="mb-0"><img src="{{ URL::asset('assets/images/users/user-3.jpg') }}"
                                        alt="" class="avatar-sm rounded-circle me-2"> James Athey</h6>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-centered table-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/user-2.jpg') }}"
                                                    alt="" class="avatar-xs rounded-circle me-2"> Philip Smead
                                            </div>
                                        </td>
                                        <td>15/1/2018</td>
                                        <td>$94</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/user-3.jpg') }}"
                                                    alt="" class="avatar-xs rounded-circle me-2"> Brent Shipley
                                            </div>
                                        </td>
                                        <td>16/1/2019</td>
                                        <td>$112</td>
                                        ...
                                        <td>
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/user-4.jpg') }}"
                                                    alt="" class="avatar-xs rounded-circle me-2"> Robert Sitton
                                            </div>
                                        </td>
                                        <td>17/1/2019</td>
                                        <td>$116</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/user-5.jpg') }}"
                                                    alt="" class="avatar-xs rounded-circle me-2"> Alberto Jackson
                                            </div>
                                        </td>
                                        <td>18/1/2019</td>
                                        <td>$109</td>
                                        ...
                                        <td>
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/user-6.jpg') }}"
                                                    alt="" class="avatar-xs rounded-circle me-2"> David Sanchez
                                            </div>
                                        </td>
                                        <td>19/1/2019</td>
                                        <td>$120</td>
